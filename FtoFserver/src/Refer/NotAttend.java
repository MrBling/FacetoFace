...
public class NotAttend extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try{
            ...
            String sqlall="select PId,name from "+classes+";";
            ...
            int columnCountall=metaData.getColumnCount();


            ArrayList objArrayall = new ArrayList();
            while (rsall.next()) {

                JSONObject jsonObj = new JSONObject();
                String PId=rsall.getString("PId");
                String name=rsall.getString("name");
                jsonObj.put(PId,name);
                objArrayall.add(jsonObj.toString());

            }
            objArrayall.removeAll(objArray);
            System.out.println( objArrayall);

            jsonObjlast.put("Attend",objArray.toString());
            jsonObjlast.put("NOTAttend",objArrayall.toString());


            pw.write(objArrayall.toString());
            stmt.close();
            conn.close();
